...
{
$sql=mysqli_query($con,"SELECT password FROM  users where password='".$_POST['password']."' && userEmail='".$_SESSION['userlogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update users set password='".$_POST['newpassword']."', updationDate='$currentTime' where userEmail='".$_SESSION['userlogin']."'");
