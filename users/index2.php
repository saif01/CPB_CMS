...
if($num>0)
{
    ...
    //$log=mysqli_query($con,"insert into userlog(uid,username,userip,status) values('".$_SESSION['id']."','".$_SESSION['login']."','$browser','$status')");
     
     $log=mysqli_query($con,"INSERT INTO `user_info`(`uid`, `username`, `userip`, `useros`, `userbrowser`, `userdevice`, `status`) VALUES ('".$_SESSION['id']."','".$_SESSION['login']."','$ip','$os','$browser','$device','$status')");
...
mysqli_query($con,"INSERT INTO `user_info`(`uid`, `username`, `userip`, `useros`, `userbrowser`, `userdevice`, `status`) VALUES ('".$_SESSION['id']."','".$_SESSION['login']."','$ip','$os','$browser','$device','$status')");
...
?>
    ...
    <head>
        ...
        <title>CMS|CPB|User Login</title>
      ...
      *********************************************************************************************************************************************************** -->
        ...
        <div id="login-page">
            <div class="container">
                ...
                <form class="form-login-saif" name="login" method="post">
                    <h2>sign in now</h2>
                    <img src="assets/img/user_s.png" class="user">
                ...
                <div class="">
                    Don't have an account yet?. Please Contact With IT Department.<br/>
                    </br>
                    <a class="brand" href="/cms/">

                        <font size="5" color="red"> Home </font>
                    </a>
