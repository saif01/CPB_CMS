    ...
    <section id="container">
        ...
        <section id="main-content" >
            <section class="wrapper site-min-height">
                <h3> Application Complain Details</h3>
                <hr>
                <div class="transStyle " style="color: black; background-color: white;">
        ...
        {?>    
                    ...
                    <div class="row mt">
                        ...
                        <label class="col-sm-2 col-sm-2 control-label"><b><i class="fa fa-folder-open-o"></i> Software </b> </label>
                        ...
                        <label class="col-sm-2 col-sm-2 control-label"><b><i class="fa fa-folder-open-o"></i> Problem In </b> </label>

                        <div class="col-sm-4">
                            <p>
                                <?php echo htmlentities($row['sub_prob']);?>
                            </p>
                        </div>
