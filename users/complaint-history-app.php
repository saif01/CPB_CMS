    ...
    <section id="container">
        ...
        <section id="main-content" class="mx-auto" style= "margin-left:225px;">
            <section class="wrapper" >
                ...
                <h3><i class="fa fa-angle-right"></i> Your Application Complaint Hstory</h3>
                <div class="row mt">
                    <div class="col-lg-12 transStyle">
                        <div class="content-panel transStyle">
                            <section id="unseen">
                                <!--table  class="datatable-1 table table-bordered table-striped table-condensed" -->
                                    ...
                                    <tbody>
                                        <?php $query=mysqli_query($con,"select * from tblcomplaints where userId='".$_SESSION['id']."' AND `cat_dep` = 'Application' ORDER BY `complaintNumber` DESC");
                    $cnt=1;                   
                                 ...
                                 ?>
                                    ...
                                    if($status=="in process"){ ?>
                                     ...
                                     if($status=="closed") {?> 
                                                ...
                                                <?php } ?>
                                                <td align="center">
                                                    <a href="complaint-details-app.php?cid=<?php echo htmlentities($row['complaintNumber']);?>">
