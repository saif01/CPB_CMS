...
?>
    ...
    <head>
        ...
        <title>Application|CPB|User Change Password</title>
 ...
 ?>
                                ...
                                <form class="form-horizontal style-form" method="post" name="profile">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-sm-2 col-sm-2 control-label">Departmenttt </label>
                                        <div class="col-sm-4">
                                            <input type="text" name="contactno" required="required" value="<?php echo htmlentities($row['dept']);?>" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="contactno" required="required" value="<?php echo htmlentities($row['sub_dept']);?>" class="form-control">
                                        </div>
                                        <label class="col-sm-2 col-sm-2 control-label">Country </label>
                                        <div class="col-sm-4">
                                            <input type="text" name="country" required="required" value="<?php echo htmlentities($row['branch']);?>" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="pincode" maxlength="6" required="required" value="<?php echo htmlentities($row['off_id']);?>" class="form-control">
                                        </div>
