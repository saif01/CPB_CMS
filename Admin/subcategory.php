...
<div class="controls">
<select name="category" class="span10 tip" required>
...
<div class="control-group">
<label class="control-label " for="basicinput">Sub Field</label>
<div class="controls">
<input type="text" placeholder="Enter Employee name"  name="subcategory" class="span10 tip" required>
</div>
</div>
...
?>									
										<tr>
											...
											<td>
											<a href="edit-subcategory.php?id=<?php echo $row['id']?>" ><button type="button" class="btn btn-info"><i class="icon-edit"></i> Edit </button></a>
										    </td>
										    <td>
											<a href="subcategory.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><button type="button" class="btn btn-danger" ><i class="icon-remove-sign"></i> Delete</button></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
