...
?>
    ...
    <head>
        ...
        <title>Admin|CPB|InProcess Complaints</title>
...
$query = mysqli_query($con,"SELECT * FROM `tblcomplaints` WHERE `cat_dep` = 'Application' AND `status` = '$status'");
...
?>
                                            <tr>
                                                ...
                                                <td><button type="button" class="btn btn-warning"><i class="icon-random"></i> In Process</button></td>

                                                <td> <a href="complaint-details-app.php?cid=<?php echo htmlentities($row['complaintNumber']);?>"> <button type="button" class="btn btn-success"><i class="icon-zoom-in"></i> View Details </button></a>
                                                </td>
                                            </tr>
