...
?>
    ...
    <head>
        ...
        <title>Admin|CPB|Closed Complaints</title>
                            ...
                            <div class="module">
                                ...
                                <div class="module-body table">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="98%">
										...
										$query = mysqli_query($con,"SELECT * FROM `tblcomplaints` WHERE `cat_dep` = 'Application' AND `status` = 'closed' ORDER BY `complaintNumber` DESC");
										...
										?>
                                            <tr>
                                                ...
                                                <td> <a href="complaint-details-app.php?cid=<?php echo htmlentities($row['complaintNumber']);?>"> View Details</a>
                                                </td>
                                            </tr>
