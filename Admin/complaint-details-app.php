...
?>
											...
											if($row['status']=="closed"){
                                                        ...
                                                        <a href="javascript:void(0);" onClick="popUpWindow('updatecomplaint-app.php?cid=<?php echo htmlentities($row['complaintNumber']);?>');" title="Update order ">
