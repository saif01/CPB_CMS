...
<?php }?>
					...
					if($row['status']=="closed")
                        { }
                    elseif($row['status']=="in process" && $value2['w_status']=="Warranty"){ }
                    elseif($row['status']=="in process" && $value2['w_status']=="Warranty_go"){ }
        ...
        <button type="button" class="btn btn-primary"><i class="icon-edit"></i> Take Action</button></a>
                  <?php } 
                  elseif($row['status']=="in process" && $value2['w_status']=="Warranty_back" )
        ...
        <button type="button" class="btn btn-primary"><i class="icon-edit"></i> Take Action</button></a>
                  <?php } 
                  elseif($row['status']=="in process" && $value2['w_status']=="Non Warranty" )
        ...
        <button type="button" class="btn btn-primary"><i class="icon-edit"></i> Take Action</button></a>
            ...
            <a href="javascript:void(0);" onClick="popUpWindow('delivery.php?cid=<?phpecho htmlentities($row['complaintNumber']);?>');"title="Update order ">
			<button type="button" class="btn btn-primary"><i class="icon-edit"></i> Delivery </button></a>
                                            <?php } 
            else{ } ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php 
            if($value2['w_status']=="Non Warranty")
                { }                                                 
            elseif($value2['w_status']=="Warranty") {?>

            <a href="javascript:void(0);" onClick="popUpWindow('warranty.php?cid=<?php echo htmlentities($row['complaintNumber']);?>');"title="Update order ">
            <button type="button" class="btn btn-primary"><i class="icon-edit"></i> Warranty </button></a>
                                                <?php } 
            elseif($value2['w_status']=="Warranty_go") {?>
