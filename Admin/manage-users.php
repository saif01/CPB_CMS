...
?>
    ...
    <head>
        ...
        <title>Admin|C.P.B|Manage Users</title>
                ...
                <div class="row">
							...
							{?>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="98%">
                                        ...
                                        <tbody>
                                            ...
                                            $query=mysqli_query($con,"SELECT * FROM `users` WHERE `section`='user' ORDER BY `users`.`id` DESC");
					$cnt=1;
					...
					?>
                                        ...
                                        <?php
                                         if($row['status']==1)
                                         {?>
                                        <a href="disable_enable.php?inid=<?php echo htmlentities($row['id']);?>" onclick="return confirm('Are you sure you want to block this ** ID **?');"><button class="btn btn-danger"> <i class="icon-ban-circle"> Blocked</i></button>
                                            
                                        <?php } else {?>

                                            <a href="disable_enable.php?id=<?php echo htmlentities($row['id']);?>" onclick="return confirm('Are you sure you want to active this ** ID **?');"><button class="btn btn-primary"><i class="icon-ok-sign"> Active </i></button> 
                                            <?php } ?>
