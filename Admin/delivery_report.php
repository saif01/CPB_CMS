...
?>
    ...
    <head>
        ...
        <title>Admin|CPB|Delivery Report</title>
                ...
                <div class="row">
                                ...
                                <div  class="module-body table">
                                    ...
                                    <table  cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="98%">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $query=mysqli_query($con,"SELECT * FROM `delivery` ORDER BY `delivery`.`complaintNumber` DESC");
					$cnt=1;
					...
					?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo htmlentities($row['actionby']);?>
                                                </td>
                                                <td>
                                                    <?php echo htmlentities($row['d_status']);?>
                                                </td>
