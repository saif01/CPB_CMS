    ...
    while($row=mysqli_fetch_array($ret))
                {   
                    ...
                    {  
                       ...
                       // $device= gethostname();
                        $status=1;
                         ...
                         $log=mysqli_query($con,"INSERT INTO `user_info`(`uid`, `username`, `userip`, `useros`, `userbrowser`, `userdevice`, `status`) VALUES ('".$_SESSION['id']."','".$_SESSION['userlogin']."','$ip','$os','$browser','$device','$status')");
                    ...
                    elseif ($field =='Hardware' && $st==1) 
                    {
                        ...
                        $_SESSION['harlogin']=$_POST['username'];
                        $_SESSION['id']=$num['id'];
                        ...
                        $device= gethostname();
                        $status=1;                       
                        $log=mysqli_query($con,"INSERT INTO `user_info`(`uid`, `username`, `userip`, `useros`, `userbrowser`, `userdevice`, `status`) VALUES ('".$_SESSION['id']."','".$_SESSION['harlogin']."','$ip','$os','$browser','$device','$status')");
                    ...
                    elseif ($field =='Application' && $st==1) 
                    {
                        ...
                        $_SESSION['Admin'] = $_POST['username'];
                        $_SESSION['applogin']=$_POST['username'];
                        $_SESSION['id']=$num['id'];
                        ...
                        $status=1;
                         ...
                         $log=mysqli_query($con,"INSERT INTO `user_info`(`uid`, `username`, `userip`, `useros`, `userbrowser`, `userdevice`, `status`) VALUES ('".$_SESSION['id']."','".$_SESSION['applogin']."','$ip','$os','$browser','$device','$status')");
                        exit();
                    ...
                    elseif ($field=='Admin' && $st==1) 
                    {
                        ...
                        $_SESSION['Admin'] = $_POST['username'];
                        $_SESSION['mainAdmin']=$_POST['username'];
                        $_SESSION['id']=$num['id'];
                        ...
                        $status=1;
                         ...
                         $log=mysqli_query($con,"INSERT INTO `user_info`(`uid`, `username`, `userip`, `useros`, `userbrowser`, `userdevice`, `status`) VALUES ('".$_SESSION['id']."','".$_SESSION['mainAdmin']."','$ip','$os','$browser','$device','$status')");
                        exit();
                    }
                            ...
                            <div class="module-body">
                                <div class="control-group">
                                    <div class="controls row-fluid">
                                        ...
                                        <input class="span12" type="text" id="inputEmail" name="username" placeholder="User-mail">
