                            ...
                            <div class="module">
                                ...
                                <div class="module-body table">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped  display" width="100%">
                                        ...
                                        $query = mysqli_query($con,"SELECT * FROM `tblcomplaints` WHERE `cat_dep` = 'Hardware' AND `status` = 'closed' ORDER BY `complaintNumber` DESC");
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><button type="button" class="btn btn-success">Closed</button>
                                                    <?php
